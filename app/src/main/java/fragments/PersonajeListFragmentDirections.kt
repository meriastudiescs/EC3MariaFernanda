...
public class PersonajeListFragmentDirections private constructor() {
    ...
    public override val arguments: Bundle
      ...
      get() {
        ...
        if (Parcelable::class.java.isAssignableFrom(Personaje::class.java)) {
          result.putParcelable("note", this.personaje as Parcelable)
        } else if (Serializable::class.java.isAssignableFrom(Personaje::class.java)) {
          result.putSerializable("note", this.personaje as Serializable)
        } else {
  ...
  public companion object {
    public fun actionPersonajeListFragmentToPersonajeDetailFragment(personaje: Personaje): NavDirections =
        ActionPersonajeListFragmentToPersonajeDetailFragment(personaje)
  }
}
