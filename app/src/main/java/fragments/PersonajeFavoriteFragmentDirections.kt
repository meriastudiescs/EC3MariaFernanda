...
public class PersonajeFavoriteFragmentDirections private constructor() {
  private data class ActionPersonajeFavoriteFragmentToPersonajeDetailFragment(
    public val personaje: Personaje
  ) : NavDirections {
    public override val actionId: Int = R.id.action_PersonajeFavoriteFragment_to_personajeDetailFragment
  ...
  public companion object {
    public fun actionPersonajeFavoriteFragmentToPersonajeDetailFragment(personaje: Personaje): NavDirections =
        ActionPersonajeFavoriteFragmentToPersonajeDetailFragment(personaje)
  }
}
