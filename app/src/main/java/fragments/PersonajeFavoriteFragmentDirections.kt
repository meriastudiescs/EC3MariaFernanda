...
public class NoteFavoriteFragmentDirections private constructor() {
  private data class ActionNoteFavoriteFragmentToNoteDetailFragment(
    public val note: Note
  ) : NavDirections {
    public override val actionId: Int = R.id.action_noteFavoriteFragment_to_noteDetailFragment
  ...
  public companion object {
    public fun actionNoteFavoriteFragmentToNoteDetailFragment(note: Note): NavDirections =
        ActionNoteFavoriteFragmentToNoteDetailFragment(note)
  }
}
